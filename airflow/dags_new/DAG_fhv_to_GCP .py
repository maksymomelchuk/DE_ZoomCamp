...
BIGQUERY_DATASET = os.environ.get("BIGQUERY_DATASET", 'fhv_2019')
...
OUTPUT_FILE_TEMPLATE = 'fhv_{{ execution_date.strftime("%Y-%m") }}'
...
with local_workflow:
    ...
    local_to_gcs_task = PythonOperator(
        ...
        op_kwargs={
            "bucket": BUCKET,
            "object_name": f"fhv/{OUTPUT_FILE_TEMPLATE}",
    ...
    bigquery_external_table_task = BigQueryCreateExternalTableOperator(
        ...
        table_resource={
            ...
            "externalDataConfiguration": {
                ...
                "sourceUris": [f"gs://{BUCKET}/fhv/fhv_2019-*"],
            },
        },
    )
